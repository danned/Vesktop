...
export const enum IpcEvents {
    ...
    MPV_STREAM_START = "VCD_MPV_STREAM_START",
    MPV_STREAM_VIDEO_FRAME = "VCD_MPV_STREAM_VIDEO",
    MPV_STREAM_AUDIO_FRAME = "VCD_MPV_STREAM_AUDIO",
    MPV_STREAM_STOP = "VCD_MPV_STREAM_STOP",
